...
//  headerTitleLabel.shadowColor = [UIColor whiteColor];
  headerTitleLabel.shadowColor = [UIColor clearColor];
...
//  NSArray *weekdayNames = [[[[NSDateFormatter alloc] init] autorelease] shortWeekdaySymbols];
  NSArray *weekdayNames = @[@"日", @"一", @"二", @"三", @"四", @"五", @"六"];
...
//      weekdayLabel.shadowColor = [UIColor whiteColor];
    weekdayLabel.shadowColor = [UIColor clearColor];
...
- (void)addSubviewsToContentView:(UIView *)contentView
{
  ...
  gridView = [[KalGridView alloc] initWithFrame:fullWidthAutomaticLayoutFrame logic:logic delegate:delegate];
    gridView.isSingleDate = isSingleDate;
    
  [gridView addObserver:self forKeyPath:@"frame" options:NSKeyValueObservingOptionNew context:NULL];
  [contentView addSubview:gridView];

#ifndef __TRAIN_FINDER__
...
- (void)getDateSelected:(NSDate **)sDate {
    [gridView getDateSelected:sDate];
}
...
- (void)setInitSelectedDate:(NSDate *)dateSelect {
    [gridView setInitSelectedDate:dateSelect];
}
